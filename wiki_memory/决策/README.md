...
| [ADR-005 多页面管理与持久恢复](./ADR-005-多页面管理与持久恢复.md) | 已被 ADR-006 替代；保留原隔离清理决策作为历史 |
| [ADR-006 多页面管理与回收站直接清理](./ADR-006-多页面管理与回收站直接清理.md) | 六页应用壳、持久部署、直接回收站清理和遗留兼容门禁 |
| [ADR-007 排除视频的双向仓库备份](./ADR-007-排除视频的双向仓库备份.md) | 双向非视频镜像、视频保留和模式基线隔离 |
